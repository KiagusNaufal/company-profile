...
@section('content')
    ...
    <section
        class="relative py-16 sm:py-24 md:py-32 bg-gradient-to-r from-blue-50 to-gray-50 overflow-hidden scroll-reveal-section">
        <!-- Background elements -->
        ...
        <div class="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 md:gap-12">
                ...
                <div
                    class="flex flex-col items-center text-center p-4 sm:p-6 rounded-xl bg-white hover:shadow-lg transition-all">
                    <div
                        class="w-16 h-16 sm:w-20 sm:h-20 bg-black rounded-2xl flex items-center justify-center mb-4 sm:mb-6">
                        <svg class="w-8 h-8 sm:w-10 sm:h-10 text-white" fill="none" stroke="currentColor"
                            viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
    ...
    <section class="relative py-12 sm:py-16 md:py-20 bg-white overflow-hidden scroll-reveal-section">
        <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="text-center mb-12 sm:mb-16">
                <div class="relative inline-block mb-6 sm:mb-8">
                    <img src="https://images.unsplash.com/photo-1573164713988-8665fc963095?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2069&q=80"
                        ...
                        class="w-full max-w-4xl mx-auto rounded-xl sm:rounded-2xl shadow-lg sm:shadow-xl">
                    <div class="absolute inset-0 bg-gradient-to-t from-black/40 to-transparent rounded-xl sm:rounded-2xl">
                    </div>
                    <h2
                        class="absolute bottom-4 sm:bottom-8 left-0 right-0 text-2xl sm:text-3xl md:text-4xl font-bold text-white">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12">
                <!-- Vision Section -->
                <div
                    class="bg-white p-6 sm:p-8 rounded-xl sm:rounded-2xl shadow-lg border-l-4 border-[#003366] relative overflow-hidden scroll-reveal-section">
                ...
                <!-- Mission Section -->
                <div
                    class="bg-white p-6 sm:p-8 rounded-xl sm:rounded-2xl shadow-lg border-l-4 border-[#04b2f7] relative overflow-hidden scroll-reveal-section">
                    <div class="flex items-center mb-4 sm:mb-6">
                    ...
                    <div class="space-y-4 sm:space-y-6">
                        ...
                        <div class="flex group">
                            <div class="flex-shrink-0 mr-3 sm:mr-4">
                                <div
                                    class="w-10 h-10 sm:w-12 sm:h-12 bg-[#04b2f7]/10 rounded-lg flex items-center justify-center group-hover:bg-[#04b2f7] transition-colors">
                                    <svg class="w-5 h-5 sm:w-6 sm:h-6 text-[#04b2f7] group-hover:text-white"
            ...
            <div class="relative">
                ...
                <div class="space-y-8 sm:space-y-16">
                    ...
                    <div class="relative flex flex-col sm:flex-row items-center justify-between timeline-item">
                        ...
                        <div
                            class="hidden sm:block absolute left-1/2 w-4 h-4 sm:w-6 sm:h-6 bg-[#04b2f7] rounded-full border-4 border-white transform -translate-x-1/2">
                        </div>
    ...
    <!-- Team Section -->
    <section id="member-section" class="py-12 sm:py-16 md:py-20 bg-gray-50 scroll-reveal-section">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <!-- Section Header -->
            <div class="text-center mb-12 sm:mb-16">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
                <!-- Team Member 1 -->
                <div
                    class="bg-white rounded-lg sm:rounded-xl shadow-md overflow-hidden transition-all duration-300 hover:shadow-lg hover:-translate-y-1">
            ...
            <div class="mt-12 md:mt-20">
                ...
                <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-4 md:gap-6">
                    ...
                    <div class="text-center">
                        <div
                            class="w-20 h-20 sm:w-24 sm:h-24 md:w-28 md:h-28 mx-auto mb-3 md:mb-4 rounded-full overflow-hidden border-4 border-white shadow-lg">
