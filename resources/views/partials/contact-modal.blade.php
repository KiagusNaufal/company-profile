<div class="fixed inset-0 z-[9999] hidden" id="contactModal">
    ...
    <div class="fixed inset-y-0 right-0 w-full max-w-md z-[9999]">
        <div class="modal-panel h-full flex flex-col bg-white shadow-xl transform transition-transform duration-500 ease-[cubic-bezier(0.16,1,0.3,1)]">
            ...
            <!-- Form -->
            <form class="flex-1 flex flex-col p-6 space-y-6 overflow-y-auto" action="https://formspree.io/f/xwpobgdw"
                method="POST">
                ...
                <div class="space-y-6">
                    ...
                    <div class="relative">
                        ...
                        <label for="name"
                            class="absolute left-0 top-3 text-gray-500 peer-focus:text-[#04b2f7] peer-focus:scale-90 peer-focus:-translate-y-2.5 peer-valid:scale-90 peer-valid:-translate-y-2.5 transition-all duration-300 transform origin-left">
                            Full Name
                        </label>
                    </div>
