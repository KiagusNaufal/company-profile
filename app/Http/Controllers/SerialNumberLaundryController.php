...
class SerialNumberLaundryController extends Controller
{
        public function login(Request $request)
    {
        try {
            $request->validate([
                'serialNumber' => [
                    'required',
                    'string',
                    'exists:serial_number_laundry,serialNumber'
                ],
                'password' => [
                    'required',
                    'string',
        ...
        try {
            $serial = SerialNumberLaundry::where('serialNumber', $request->serialNumber)->first();
    ...
    public function changePassword(Request $request, $serialNumberId)
{
    try {
        ...
        $serialNumber = SerialNumberLaundry::find($serialNumberId);
...
public function update(Request $request, $serialNumberId)
{
    ...
    try {
        ...
        $updatedSerialNumber = SerialNumberLaundry::find($serialNumberId);
