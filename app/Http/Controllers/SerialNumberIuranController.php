...
class SerialNumberIuranController extends Controller
{
        public function login(Request $request)
    {
        try {
            $request->validate([
                'serialNumber' => [
                    'required',
                    'string',
                    'exists:serial_number_iuran,serialNumber'
                ],
                'password' => [
                    'required',
                    'string',
        ...
        try {
            $serial = SerialNumberIuran::where('serialNumber', $request->serialNumber)->first();
    ...
    public function changePassword(Request $request, $serialNumberId)
{
    try {
        ...
        $serialNumber = SerialNumberIuran::find($serialNumberId);
...
public function update(Request $request, $serialNumberId)
{
    ...
    try {
        ...
        $updatedSerialNumber = SerialNumberIuran::find($serialNumberId);
