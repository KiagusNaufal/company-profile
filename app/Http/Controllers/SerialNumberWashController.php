...
class SerialNumberWashController extends Controller
{
        public function login(Request $request)
    {
        try {
            $request->validate([
                'serialNumber' => [
                    'required',
                    'string',
                    'exists:serial_number_wash,serialNumber'
                ],
                'password' => [
                    'required',
                    'string',
        ...
        try {
            $serial = SerialNumberWash::where('serialNumber', $request->serialNumber)->first();
    ...
    public function changePassword(Request $request, $serialNumberId)
{
    try {
        ...
        $serialNumber = SerialNumberWash::find($serialNumberId);
...
public function update(Request $request, $serialNumberId)
{
    ...
    try {
        ...
        $updatedSerialNumber = SerialNumberWash::find($serialNumberId);
