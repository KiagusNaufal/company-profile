...
class SerialNumberBasicController extends Controller
{
        public function login(Request $request)
    {
        try {
            $request->validate([
                'serialNumber' => [
                    'required',
                    'string',
                    'exists:serial_number_basic,serialNumber'
                ],
                'password' => [
                    'required',
                    'string',
        ...
        try {
            $serial = SerialNumberBasic::where('serialNumber', $request->serialNumber)->first();
    ...
    public function changePassword(Request $request, $serialNumberId)
{
    try {
        ...
        $serialNumber = SerialNumberBasic::find($serialNumberId);
...
public function update(Request $request, $serialNumberId)
{
    ...
    try {
        ...
        $updatedSerialNumber = SerialNumberBasic::find($serialNumberId);
