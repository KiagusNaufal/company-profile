...
class SerialNumberBengkelController extends Controller
{
        public function login(Request $request)
    {
        try {
            $request->validate([
                'serialNumber' => [
                    'required',
                    'string',
                    'exists:serial_number_bengkel,serialNumber'
                ],
                'password' => [
                    'required',
                    'string',
        ...
        try {
            $serial = SerialNumberBengkel::where('serialNumber', $request->serialNumber)->first();
    ...
    public function changePassword(Request $request, $serialNumberId)
{
    try {
        ...
        $serialNumber = SerialNumberBengkel::find($serialNumberId);
...
public function update(Request $request, $serialNumberId)
{
    ...
    try {
        ...
        $updatedSerialNumber = SerialNumberBengkel::find($serialNumberId);
